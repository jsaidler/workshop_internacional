...
try{
    ...
    $result=media_regenerate_image_asset(database(),$assetId,$scope==='all');
    echo json_encode($result,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}catch(Throwable $e){http_response_code(422);error_log('media.regenerate '.$e->getMessage());echo json_encode(['error'=>$e->getMessage()]);}