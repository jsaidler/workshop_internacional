...
content_json(['csrf'=>csrf_token('cms-editor'),'pageId'=>$pageId,'pageAccess'=>(string)($page['access_level']??'public'),'cohorts'=>$cohorts,'lessons'=>$lessons,'timezone'=>(string)(app_config()['timezone']??'UTC')]);
