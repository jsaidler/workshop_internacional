...
function student_shell_activity(?array $activity,?array $student): ?array {
    ...
    if(!$student||!function_exists('student_account_enrollments'))return null;
    $enrollments=student_account_enrollments(database(),(int)$student['id']);
    foreach($enrollments as $enrollment){
        $candidate=activity_by_id(database(),(int)$enrollment['activity_id']);
