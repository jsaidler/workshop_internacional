...
function admin_shell_end(): void {$assetVersion=h(admin_asset_version());?></div></main></div><script src="/assets/admin.js?v=<?=$assetVersion?>"></script><script src="/assets/admin-ux-v2.js?v=<?=$assetVersion?>"></script></body></html><?php }
