...
$conditional=cms_validate_form_schema(['fields'=>[
    ['id'=>'has_question','type'=>'radio','label'=>'Tem dúvida?','required'=>true,'options'=>[['value'=>'yes','label'=>'Sim'],['value'=>'no','label'=>'Não']]],
    ['id'=>'question','type'=>'text','label'=>'Qual dúvida?','required'=>true],
]]);
...
$publicJs=(string)file_get_contents(__DIR__.'/../assets/public.js');expect_p3(str_contains($publicJs,'/form-config.php')&&str_contains($publicJs,'data.cmsCondition'),'public conditional form loader missing');
