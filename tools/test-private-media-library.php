...
$db->exec("INSERT INTO cms_pages(id) VALUES(1); INSERT INTO media_assets(id,asset_uuid,kind,title,default_alt,original_name,archived_at,updated_at,visibility) VALUES(7,'abc','image','Info','','info.png',NULL,'x','private');");
