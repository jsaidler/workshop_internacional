...
$db->exec("INSERT INTO media_assets(id,active_version_id,kind,title,original_name,byte_size,width,height,archived_at) VALUES(10,100,'image','Retrato','retrato.png',1000,1200,800,NULL);INSERT INTO media_versions VALUES(100,10,'a/original.png','v100','ready');INSERT INTO media_derivatives VALUES(1,100,'responsive',480,320,'png','image/png','a/480.png',500,'x'),(2,100,'responsive',1024,683,'png','image/png','a/1024.png',800,'y')");
$grid=media_list_grid_items($db,'active');
must(count($grid)===1,'grid should return the active asset');
must($grid[0]['title']==='Retrato','grid should keep asset metadata');
must(count($grid[0]['derivatives'])===2,'grid should batch active derivatives');
