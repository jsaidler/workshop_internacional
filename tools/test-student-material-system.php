...
$oldHtml='<div class="positive-handbook"><style id="positive-handbook-style">.bad{}</style><section class="sheet cover" data-cms-section="caderno-capa"><div class="cover-copy"><h1>Positivo direto</h1></div></section><section class="sheet" data-cms-section="caderno-01-principio"><p>Princípio</p></section><section class="sheet" data-cms-section="caderno-03-exposicao"><p>Exposição</p></section><section class="sheet" data-cms-section="caderno-04-reciprocidade"><p>Reciprocidade</p></section><section class="sheet" data-cms-section="caderno-06-imagem-latente"><p>Imagem latente</p></section><section class="sheet" data-cms-section="caderno-12"><p>Positivo? Negativo?</p></section><section class="sheet final" data-cms-section="caderno-18-final"><p>Final</p></section></div>';
...
foreach(['data-cms-section="caderno-aula-1"','data-cms-section="caderno-aula-2"','data-cms-section="caderno-aula-3"','class="cms-document-index"','class="cms-document-page','class="cms-lesson-divider"'] as $needle)if(!str_contains($html,$needle))fail_material('document structure missing: '.$needle);
foreach(['<style','<svg',' style=','class="positive-handbook"','class="sheet'] as $needle)if(str_contains(mb_strtolower($html,'UTF-8'),mb_strtolower($needle,'UTF-8')))fail_material('legacy/page-local visual code leaked: '.$needle);
...
$css=(string)file_get_contents(__DIR__.'/../assets/cms.css');foreach(['.cms-document{','.cms-document-page{','.cms-lesson-divider{','.cms-document-index{'] as $needle)if(!str_contains($css,$needle))fail_material('shared document CSS missing: '.$needle);
