...
<section class="hero" data-cms-section="hero" data-cms-section-name="Início">
  <div class="hero-copy">
    ...
    <div class="hero-bottom">
      ...
      <div class="cta-row"><a class="button button-primary" href="#interesse" data-cms-editable>Quero receber data e valor <span aria-hidden="true">↘</span></a><p class="microcopy" data-cms-editable>Cadastre-se para receber as informações da primeira turma.</p></div>
    </div>
  </div>
  <figure class="hero-image" data-cms-image-block>
    <img src="/assets/media/joao-portrait.webp" alt="João Saidler" data-cms-image>
    <figcaption><span data-cms-editable>Oficina Pinhole Lambe-Lambe</span><span data-cms-editable>João Saidler</span></figcaption>
  </figure>
</section>

<section class="cms-support" data-cms-section="project" data-cms-section-name="A câmera">
  <div class="cms-support-inner">
    <div>
      ...
      <p data-cms-editable>Uma câmera pinhole forma a imagem por uma pequena abertura, sem lente. Nesta oficina, esse princípio aparece em uma Pinhole Lambe-Lambe: câmera e pequeno laboratório reunidos no mesmo equipamento.</p>
      ...
      <p class="technical-note" data-cms-editable>Projeto autoral desenvolvido por João Saidler.</p>
    </div>
  </div>
</section>
...
<section class="format" data-cms-section="offer" data-cms-section-name="A oficina">
  <div class="format-inner">
    ...
    <div class="format-heading"><h2 data-cms-editable>Você recebe o projeto e acompanha a construção do começo ao fim.</h2><p data-cms-editable>Antes do encontro, você recebe um PDF com a lista de materiais e as peças para imprimir, colar no papel paraná e recortar.</p></div>
    <div class="format-grid">
      <article class="format-card"><span class="number">01</span><h3 data-cms-editable>Construção</h3><p data-cms-editable>A montagem completa é apresentada etapa por etapa, dos componentes à câmera pronta.</p></article>
...
<section class="interest cms-form-section" id="interesse" data-cms-section="interest" data-cms-section-name="Lista de interesse">
  <div class="interest-inner">
    <div class="interest-intro"><p class="section-label" data-cms-editable>05 / Primeira turma</p><h2 data-cms-editable>Receba a data e o valor.</h2><p data-cms-editable>Cadastre seu nome e e-mail para receber as informações de inscrição assim que a turma abrir.</p></div>
...
HTML;
    ...
    $formSchema=[
        'version'=>1,
        'submitLabel'=>'Quero receber data e valor',
        'successTitle'=>'Cadastro confirmado',
        'successMessage'=>'Você receberá as informações da primeira turma quando as inscrições abrirem.',
        'fields'=>[
            ...
            ['id'=>'consent','type'=>'consent','label'=>'Quero receber informações sobre a Oficina Pinhole Lambe-Lambe.','required'=>true,'width'=>'full'],
        ],
    ];
    ...
    foreach($pages as $pageIdRaw){
        ...
        if($hasSeo){
            ...
            $seo->execute([
                ...
                'Oficina on-line e ao vivo sobre a construção e a operação de uma Pinhole Lambe-Lambe autoral, com projeto completo em PDF.',
                'Oficina Pinhole Lambe-Lambe — João Saidler',
                'Uma câmera fotográfica sem lente e um pequeno laboratório no mesmo equipamento, construídos com materiais simples.',
                '',
                '',
                'index,follow',
                $now,
