...
return static function(PDO $db): void {
    ...
    foreach($rows as $row){
        ...
        try{
            ...
            // If a legacy PNG cannot be rebuilt, invalidate its derivatives.
            // media_image_sources() then falls back to the untouched original.
            // Never leave the browser pointed at a possibly stale/corrupt URL.
